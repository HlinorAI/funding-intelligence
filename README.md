...
See [benchmark methodology](docs/benchmark-methodology.md) and [`benchmarks/`](benchmarks/) for the source-bound expectations. The current suite contains two completed public-only cases; planned cases are not counted as evidence.
