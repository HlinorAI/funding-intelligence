...
python3 runtime/verify_route.py \
  ...
  --evidence-dir evidence/hlinor \
  --live \
  --output hlinor-route-verification.yaml
```

The command does not mutate knowledge cards. It emits one route record with four independent states:
